class FinancesController < ApplicationController
  ...
  def generate_monthly_payments
    ...
    if count > 0
      redirect_to community_finance_path(@community), notice: "#{count} payments generated for this month."
    else
      redirect_to community_finance_path(@community), alert: "No new payments were generated. All members already have a payment for this month."
    end
  end
